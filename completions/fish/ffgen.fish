...
complete -c ffgen -n "__fish_seen_subcommand_from group" -l format -d 'Data format' -r -f -a "{csv	,json	,yaml	}"
...
complete -c ffgen -n "__fish_seen_subcommand_from schema" -l format -d 'Schema format' -r -f -a "{yaml	,json	}"

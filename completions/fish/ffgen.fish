complete -c ffgen -n "__fish_use_subcommand" -l seed -d 'Seed for the random generator' -r
complete -c ffgen -n "__fish_use_subcommand" -s f -l file -d 'Schema file' -r
...
complete -c ffgen -n "__fish_seen_subcommand_from label" -s f -l file -d 'Schema file' -r
complete -c ffgen -n "__fish_seen_subcommand_from label" -s h -l help -d 'Print help information'
complete -c ffgen -n "__fish_seen_subcommand_from schema" -l seed -d 'Seed for the random generator' -r
complete -c ffgen -n "__fish_seen_subcommand_from schema" -s f -l file -d 'Schema file' -r
complete -c ffgen -n "__fish_seen_subcommand_from schema" -s h -l help -d 'Print help information'
complete -c ffgen -n "__fish_seen_subcommand_from completion" -l seed -d 'Seed for the random generator' -r
complete -c ffgen -n "__fish_seen_subcommand_from completion" -s f -l file -d 'Schema file' -r
complete -c ffgen -n "__fish_seen_subcommand_from completion" -s h -l help -d 'Print help information'
complete -c ffgen -n "__fish_seen_subcommand_from help" -l seed -d 'Seed for the random generator' -r
complete -c ffgen -n "__fish_seen_subcommand_from help" -s f -l file -d 'Schema file' -r

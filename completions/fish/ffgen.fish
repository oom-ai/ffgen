...
complete -c ffgen -n "__fish_seen_subcommand_from group" -l format -d 'Data format' -r -f -a "{csv	,json	}"
...
complete -c ffgen -n "__fish_seen_subcommand_from label" -l format -d 'Data format' -r -f -a "{csv	,json	}"

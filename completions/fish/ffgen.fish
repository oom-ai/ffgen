...
complete -c ffgen -n "__fish_seen_subcommand_from group" -l list -d 'List available groups'
...
complete -c ffgen -n "__fish_seen_subcommand_from label" -l list -d 'List available labels'
...
complete -c ffgen -n "__fish_seen_subcommand_from schema" -l list -d 'List available scenario'

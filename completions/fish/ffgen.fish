...
complete -c ffgen -n "__fish_use_subcommand" -f -a "list" -d 'List available schema'
...
complete -c ffgen -n "__fish_seen_subcommand_from group" -l seed -d 'Seed for random generator' -r
...
complete -c ffgen -n "__fish_seen_subcommand_from label" -l seed -d 'Seed for random generator' -r
